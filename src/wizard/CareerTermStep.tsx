        ...
        {phase.success ? (
          ...
          <>
            <div className="rounded border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">
              ...
              <p className="mt-1">
                Per Mongoose 2022 (page 13): a failed qualification means you cannot enter your
                chosen career <em>this term</em>. You must either submit to the draft or take the
                Drifter career. You'll be free to try a different career on a later term.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              >
                <div className="font-medium text-sm">Submit to the draft</div>
